...
const BASE_URL = import.meta.env.VITE_API_BASE_URL || 'https://coding-agent-gnancbc8bke4fqav.uaenorth-01.azurewebsites.net/run'
...
const Chat = ({ userInput }: ChatScreenProps) => {
    ...
    const handleSendMessage = async (text: string) => {
        ...
        try {
            ...
            const botText = data.result || "I'm sorry, I couldn't find an answer.";
